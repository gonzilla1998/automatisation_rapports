...
def csv_download(folder_path,separator_name="_"):
    ...
    for file in csv_files:
        ...
        df_name = os.path.splitext(file)[0].replace(" ", separator_name)
...
def csv_to_summary(folder_path,output_folder,opening_hours=(9.5,19.5),separator_name="_"):
    
    loaded_names, globals_dict = csv_download(folder_path,separator_name)
    ...
    for name in loaded_names:
        ...
        summary_rows.append({
            ...
            "Min_All": min_all,
            "Max_All": max_all,
            "Percent_Under_900_All": pct_900_all,
            "Percent_Under_1200_All": pct_1200_all,
            "Mean_Op": mean_op,
            "Min_Op": min_op,
            "Max_Op": max_op,
            "Percent_Under_900_Op": pct_900_op,
            "Percent_Under_1200_Op": pct_1200_op
        })
    ...
    return loaded_names, summary_stats
